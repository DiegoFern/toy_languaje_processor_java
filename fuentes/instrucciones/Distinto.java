...
/**
 * Instruccion <code>Distinto</code>. Determina si la subcima de la pila es
 * distinto a la cima, colocando el resultado en la cima.
 * Antes de operar aplica la regla de alineamiento de tipos.
 * 

 */
public class Distinto implements Instruccion, Serializable {

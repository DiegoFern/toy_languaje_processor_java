...
/**
 * Instruccion <code>MenorOIgual</code>. Determina si la subcima de la pila es
 * menor o igual a la cima, colocando el resultado en la cima.
 * Antes de operar, aplica la regla de alineamiento de tipos.
 * 
 */
public class MenorOIgual implements Instruccion, Serializable {

...
/**
 * Instruccion <code>Mayor</code>. Determina si la subcima de la pila es mayor
 * que la cima, colocando el resultado en la cima.
 * Antes de operar, aplica la regla de alineamiento de tipos.
 * 
 */
public class Mayor implements Instruccion, Serializable {

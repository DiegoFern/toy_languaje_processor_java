...
/**
 * Instruccion <code>MayorOIgual</code>. Determina si la subcima de la pila es
 * mayor o igual a la cima, colocando el resultado en la cima.
 * Antes de operar, aplica la regla de alineamiento de tipos.
 * 
 */
public class MayorOIgual implements Instruccion, Serializable {
